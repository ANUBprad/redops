...
class EvaluationRunModel(Base):
    """ORM model for the evaluation_runs table.

    Stores evaluation run instances with execution state, progress,
    ...
    evaluation_name: Mapped[str] = mapped_column(String(255))
    ...
    profile: Mapped[dict[str, object]] = mapped_column(JSON, default=dict)
