...
class OpenAIHealthContributor:
    """Health contributor for the OpenAI provider.

    Performs lightweight health checks against the OpenAI API.
    ...
    async def check(self) -> ProviderHealth:
        ...
        return ProviderHealth(
            ...
            message="OpenAI API reachable" if is_healthy else "OpenAI API unreachable",
