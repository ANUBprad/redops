"""Anthropic error mapping — converts SDK exceptions to framework errors."""
...
def map_anthropic_error(exc: Exception) -> ProviderException:
    """Convert an Anthropic SDK exception to a framework provider error.

    Args:
        exc: The raw Anthropic SDK exception.
    ...
    return ProviderUnavailable(
        message=f"Unexpected Anthropic error: {exc}",
        provider_name=PROVIDER_NAME,
