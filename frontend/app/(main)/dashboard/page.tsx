...
const statCards = [
  { title: "Total Evaluations", value: "24", change: "+12%", icon: FileText, color: "text-blue-500" },
  ...
  { title: "Cost (30d)", value: "$1,234", change: "+12%", icon: TrendingUp, color: "text-teal-500" },
];

const recentRuns = [
  { id: "run-001", name: "GPT-4 Safety Eval", status: "completed", progress: 100, score: 0.92, duration: "12m" },
  { id: "run-002", name: "Claude Prompt Injection", status: "running", progress: 68, score: 0.78, duration: "8m" },
  { id: "run-003", name: "Anthropic Red Team", status: "failed", progress: 45, score: 0.45, duration: "5m" },
  { id: "run-004", name: "Gemini Eval Batch", status: "completed", progress: 100, score: 0.88, duration: "22m" },
];
              ...
              {recentRuns.map((run) => (
                <div key={run.id} className="space-y-2">
                  ...
                  <div className="flex justify-between text-xs text-muted-foreground">
                    ...
                    <span>Score: {run.score.toFixed(2)} · {run.duration}</span>
                  </div>
                </div>
              ))}
            </div>
